...
public class Claim_Configuration_Test extends BaseTest {
    ...
    @Test(priority = 1, groups = {"regression"}, description = "TC01 - Verify Event: Validate Empty Field")
    ...
    @Test(priority = 2, groups = {"foundation"}, description = "TC02 - Verify Event Lifecycle: Create, Verify")
    ...
    @Test(priority = 3, groups = {"regression"}, description = "TC03 - Verify Event Lifecycle: Create, Verify, Edit, Delete")
    ...
    @Test(priority = 4, groups = {"regression"}, description = "TC04 - Verify Event: Handle Duplication")
    ...
    @Test(priority = 5, groups = {"regression"}, description = "TC05 - Verify Expense Type: Validate Empty Field")
    ...
    @Test(priority = 6, groups = {"foundation"}, description = "TC06 - Verify Expense Type Lifecycle: Create, Verify")
    ...
    @Test(priority = 7, groups = {"regression"}, description = "TC07 - Verify Expense Type Lifecycle: Create, Edit, Delete")
    ...
    @Test(priority = 8, groups = {"regression"}, description = "TC08 - Verify Expense Type: Handle Duplication")
